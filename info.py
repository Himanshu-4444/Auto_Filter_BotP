...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5362784415').split()] # Replace with the actual admin ID(s) to add
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002125627905')  # Support group id (make sure bot is admin)
...
# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002062488580")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002062488580")# Channels for force sub (make sure bot is admin)

# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', '')    # QR code image for payments
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', '@ClipmateMoviesAssistantbot')    # Owner UPI ID for payments
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/VisualMovies1")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/VisualMovies1")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/VisualMovies1")   # Third tutorial link for verification
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/VisualMovies1') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/VisualMovies1') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/VisualMovies1') # Update channel link for the bot
